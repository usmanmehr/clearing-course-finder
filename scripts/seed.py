...
# Table names are resolved at runtime, NOT hardcoded, to avoid cross-stack
# contamination. Precedence: --contacts-table/--defaults-table CLI args, then
# CONTACTS_TABLE/DEFAULTS_TABLE env vars, then the 2027 defaults below. The
# defaults are deliberately the 2027 table names - never the 2026
# "ClearingAdvisor-*" names - so a bare `seed.py` run cannot accidentally write
# into the 2026 stack's tables.
DEFAULT_CONTACTS_TABLE = "uk-clearing-advisor-2027-universities"
DEFAULT_DEFAULTS_TABLE = "uk-clearing-advisor-2027-subject-defaults"

# Populated in main() once args/env are resolved.
CONTACTS_TABLE = None
DEFAULTS_TABLE = None
...
UNIVERSITIES = [
    # Russell Group
    ("0023","University of Birmingham","B32","England","Birmingham",True,None,"Tier 2","+44 (0)121 414 3344","admissions@birmingham.ac.uk","birmingham.ac.uk/study/undergraduate/clearing","08:00 BST 13 Aug 2026","Opens 13 Aug",False,None),
    ...
    ("0100","Newcastle University","N21","England","Newcastle",True,None,"Not listed","+44 (0)191 208 3333","admissions@ncl.ac.uk","ncl.ac.uk/undergraduate/applications-offers/clearing/","08:00 BST 13 Aug 2026","Opens 13 Aug",False,None),
    ...
    ("0127","University of Southampton","S27","England","Southampton",True,20,"Not listed","+44 (0)23 8059 4732","admissions@southampton.ac.uk","southampton.ac.uk/clearing/course-vacancies","08:00-21:00 BST 13 Aug; 08:00-18:00 BST 14 Aug","Open",True,None),
    ("0132","University College London","U80","England","London",True,4,"Tier 1","+44 (0)20 7679 7742","admissions@ucl.ac.uk","ucl.ac.uk/study/prospective-students/undergraduate/clearing","08:00 BST 13 Aug 2026","Open",False,None),
    ...
    ("0042-ea","University of East Anglia","E14","England","Norwich",False,None,"Not listed","+44 (0)1603 591515","admissions@uea.ac.uk","uea.ac.uk/study/clearing","08:00 BST 13 Aug 2026","Opens 13 Aug",False,None),
    ("0109","University of Reading","R12","England","Reading",False,None,"Not listed","+44 (0)118 378 8619","student.recruitment@reading.ac.uk","reading.ac.uk/clearing/available-courses","08:00 BST 13 Aug 2026","Opens 13 Aug",False,None),
    ...
    ("0103","University of Portsmouth","P80","England","Portsmouth",False,None,"Not listed","+44 (0)23 9284 8484","admissions@port.ac.uk","port.ac.uk/clearing","08:00 BST 13 Aug 2026","Opens 13 Aug",False,None),
]
...
def main():
    global CONTACTS_TABLE, DEFAULTS_TABLE
    parser = argparse.ArgumentParser(
        description="Seed the UK Clearing Advisor 2027 DynamoDB tables.")
    parser.add_argument(
        "--contacts-table",
        default=os.environ.get("CONTACTS_TABLE", DEFAULT_CONTACTS_TABLE),
        help="University contacts table name (env CONTACTS_TABLE; default "
             "%s)." % DEFAULT_CONTACTS_TABLE)
    parser.add_argument(
        "--defaults-table",
        default=os.environ.get("DEFAULTS_TABLE", DEFAULT_DEFAULTS_TABLE),
        help="Subject defaults table name (env DEFAULTS_TABLE; default "
             "%s)." % DEFAULT_DEFAULTS_TABLE)
    args = parser.parse_args()
    CONTACTS_TABLE = args.contacts_table
    DEFAULTS_TABLE = args.defaults_table
